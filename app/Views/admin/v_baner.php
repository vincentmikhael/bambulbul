                ...
                <tbody>
                    ...
                    foreach ($baner as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center"><button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_baner'] ?>"><i class="fas fa-edit"></i></button>
    ...
    <div class="modal fade" id="delete<?= $value['id_baner'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Ingin Menghapus Data <b><?= $value['ket'] ?></b> ?
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
