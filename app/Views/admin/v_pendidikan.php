                ...
                <tbody>
                    ...
                    foreach ($pendidikan as $key => $value) { ?>
                        <tr>
                            ...
                            <td><button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_pendidikan'] ?>"><i class="fas fa-edit"></i></button>
    ...
    <div class="modal fade" id="delete<?= $value['id_pendidikan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Ingin Menghapus Data <b><?= $value['pendidikan'] ?></b> ?
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
