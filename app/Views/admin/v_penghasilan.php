                ...
                <tbody>
                    ...
                    foreach ($penghasilan as $key => $value) { ?>
                        <tr>
                            ...
                            <td><button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_penghasilan'] ?>"><i class="fas fa-edit"></i></button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>penghasilan</label>
                        <input name="penghasilan" value="<?= $value['penghasilan'] ?>" class="form-control" placeholder="Edit Penghasilan" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="delete<?= $value['id_penghasilan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Ingin Menghapus Data <b><?= $value['penghasilan'] ?></b> ?
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
