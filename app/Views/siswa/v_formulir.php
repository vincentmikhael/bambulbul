            ...
            <div class="card-body">
                <?php if ($siswa['stat_pendaftaran'] == 0) { ?>
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        Harap Isi Biodata Secara Lengkap. <br>
                        Dan Pastikan Data Anda Sudah Benar Sebelum Apply!!
                    </div>
                <?php } else { ?>
                    <div class="alert alert-info alert-dismissible">
                        <h5><i class="icon fas fa-exclamation-triangle"></i>Pendaftaran Sudah Dikirim !!</h5>
                        Silahkan Menunggu Pengumuman Hasil Penerimaan !
                    </div>
                <?php } ?>
...
<?php } elseif ($siswa['stat_ppdb'] == '1') { ?>
    <div class="col-sm-12">
        <div class="bg-success p-3 text-white">
            <h5><i class="icon fas fa-check"></i> **SELAMAT ANDA TELAH DITERIMA !!**</h5>
            Silahkan Cetak Bukti Diterima <a href="<?= base_url('Siswa/bukti_lulus') ?>" target="_blank" class="text-primary"> Disini</a>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="card card-outline card-primary">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <strong><i class="fas fa-globe"></i> Provinsi</strong>
                                    <?= ($siswa['nama_provinsi'] == null) ? '<p class="text-danger">Wajib Diisi!</p>' : '<p class="text-muted">' . $siswa['nama_provinsi'] . '</p>'  ?>
                                    <strong><i class="fas fa-globe"></i> Kabupaten/Kota</strong>
                                    <?= ($siswa['nama_kabupaten'] == null) ? '<p class="text-danger">Wajib Diisi!</p>' : '<p class="text-muted">' . $siswa['nama_kabupaten'] . '</p>'  ?>
                                </div>
                                <div class="col-sm-6">
                                    <strong><i class="fas fa-home"></i> Kecamatan</strong>
                                    <?= ($siswa['nama_kecamatan'] == null) ? '<p class="text-danger">Wajib Diisi!</p>' : '<p class="text-muted">' . $siswa['nama_kecamatan'] . '</p>'  ?>
                                    <strong><i class="fas fa-map-marker-alt"></i></i> Alamat</strong>
                                    <?= ($siswa['alamat'] == null) ? '<p class="text-danger">Wajib Diisi!</p>' : '<p class="text-muted">' . $siswa['alamat'] . '</p>'  ?>
                                </div>
                            </div>
                        </div>
                ...
                <?php if ($siswa['stat_pendaftaran'] == 1) { ?>
                    <div class="col-sm-12">
                        <button class="btn btn-success btn-flat btn-block" data-toggle="modal" data-target="#apply"><i class="fas fa-check"></i> Upload Kwitansi</button>
                    </div>
                <?php } ?>
...
<?php } else { ?>
    <div class="col-sm-12">
        <div class="bg-danger p-3 text-white">
            <h5><i class="icon fas fa-times"></i>**MAAF ANDA BElUM DITERIMA !!**</h5>
            Tetep Semangat Ya.. <br>
            Dicoba Lagi Tahun Depan !!
        </div>
    </div>
<?php } ?>
