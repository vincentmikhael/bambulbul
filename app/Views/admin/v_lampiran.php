                ...
                <tbody>
                    ...
                    foreach ($lampiran as $key => $value) { ?>
                        <tr>
                            ...
                            <td><button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_lampiran'] ?>"><i class="fas fa-edit"></i></button>
    ...
    <div class="modal fade" id="delete<?= $value['id_lampiran'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Ingin Menghapus Data <b><?= $value['lampiran'] ?></b> ?
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
